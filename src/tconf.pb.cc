...
void protobuf_AssignDesc_tconf_2eproto() {
  ...
  static const int TconfTable_offsets_[2] = {
...
void protobuf_AddDesc_tconf_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "onfColDef\022\027\n\004rows\030\002 \003(\0132\t.TconfRow", 154);
...
const ::std::string TconfColDef::_default_name_;
const ::std::string TconfColDef::_default_type_;
#ifndef _MSC_VER
...
const TconfColDef& TconfColDef::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_tconf_2eproto();  return *default_instance_;
}
