...
{
	//EFFECT_CONDITION_ACTION_START區域
	EFFECT_PRIORITY_BUFF_HPDOWN,
	

	//EFFECT_CONDITION_BEFORE_ATTACK區域
	EFFECT_PRIORITY_BUFF_ATTACKUP,
	EFFECT_PRIORITY_BUFF_ATTACKDOWN,
	EFFECT_PRIORTIY_SKILL_DMGUP,
	EFFECT_PRIORTIY_SKILL_DMG,
	EFFECT_PRIORITY_SKILL_MUTIL_ATTCK,

	//EFFECT_CONDITION_BEFORE_BEATTACK區域
	EFFECT_PRIORITY_BUFF_DEFDOWN,	

	//EFFECT_CONDITION_ATTACK區域
	EFFECT_PRIORITY_DEFAULT_DMG,

	//EFFECT_CONDITION_AFTER_ATTACK區域
	EFFECT_PRIORITY_SKILL_DEBUFF_ATTACKUP,

	//EFFECT_CONDITION_AFTER_BEATTACK區域
	EFFECT_PRIORITY_SKILL_DEBUFF_HPDOWN,
	EFFECT_PRIORITY_SKILL_DEBUFF_DEFDOWN,
	EFFECT_PRIORITY_SKILL_DEBUFF_ATTACKDOWN,
